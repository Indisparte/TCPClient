...
public class UserPreferenceManager {
    ...
    private UserPreferenceManager() {
        mPreferenceManager = ClientApplication.getContext().getSharedPreferences(USERNAME_PREF_KEY, Context.MODE_PRIVATE);
    }
    ...
    public  static void saveUsername(@NonNull String username) {
        SharedPreferences.Editor editor = UserPreferenceManager.getInstance().mPreferenceManager.edit();
